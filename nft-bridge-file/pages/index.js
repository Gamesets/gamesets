...
export default function Home() {
      ...
      return (
        <div>
          <Row css={{ marginTop: "$1" }}>
            ...
            <img src="ethereumlogo.svg" width={"190px"} />
          </Row>
          <Row>
  ...
  async function initTransfer() {
    ...
    if (bsc == destChain) {
      ...
      var dRpc = goerpc;
      var explorer = "https://aurorascan.dev";
      var dNFT = goeNFT;
    }
    const tokenId = id;
    const web3Modal = new Web3Modal();
    ...
    <div>
      ...
      <Container sm="true">
        ...
        <Grid>
          ...
          >
            The&nbsp;GameSets&nbsp;asset&nbsp; bridge&nbsp; is&nbsp; meant&nbsp;
            to&nbsp; do&nbsp; one&nbsp; thing,&nbsp; provide&nbsp; a
            &nbsp;transport&nbsp; mechanism&nbsp; to&nbsp; safely&nbsp;
            move&nbsp; Tokens&nbsp; and&nbsp; NFTs&nbsp; between&nbsp;
